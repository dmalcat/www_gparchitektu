...
<head>
	...
	<title>GPA 2002 | Grand Prix Architektů</title>
...
<section class="hero hero--subpage hero--video">
	<div class="hero__wrapper wrapper">
		<img class="hero__logo" src="<?php echo $baseurl ?>/assets/images/competition/logo-2002-tran.png" alt="">
	</div>
			...
			<div class="gpa gpa--projects">
				<div class="gpa__row gpa__row--projects row">
					<div class="gpa__col">
						...
						-->
						<h3 class="gpa__projectName">Národní cena za&nbsp;architekturu 2002</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Knihovna Filozofické fakulty Masarykovy univerzity v Brně</span>
							<strong>Autor</strong>: Ladislav Kuba, Tomáš Pilař, spoluautor Lenka Počtová, Martin Klimecký, Zdena Pavelková<br>
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<strong>Oceněný</strong>: Josef Svoboda<br>
						</span>
					</div>
					<div class="gpa__col">
						<!--
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Úpravy Horního náměstí v Olomouci</span>
							<strong>Autor</strong>: Petr Hájek, Jaroslav Hlásek, Jan Šépka, spolupráce Jana Zlámalová, Ladislav Monzer<br>
							<strong>Cena:</strong> Malá modrá kostka
						</span>
					</div>
					<div class="gpa__col">
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Kašna, Masarykovo náměstí, Hradec Králové</span>
							<strong>Autor</strong>: Michal Gabriel, Oleg Haman, spolupráce Jana Jiřincová<br>
							<strong>Cena:</strong> Malá modrá kostka
						</span>
					</div>
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__projectDesc">
								<span class="gpa__title"><strong>Název projektu:</strong> Knihovna Filozofické fakulty Masarykovy univerzity v Brně</span>
								<strong>Autor</strong>: Ladislav Kuba, Tomáš Pilař, spolupráce Lenka Počtová, Martin Klimecký<br>
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Vilové bytové domy, Brno</span>
							<strong>Autor</strong>: Tomáš Pilař, Eva Pilařová, spoluautor Luboš Olešovský, Vít Košťál, Radka Drábková<br>
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Rekonstrukce Uměleckoprůmyslového muzea v Brně</span>
							<strong>Autor</strong>: Ivan Koleček, Viktor Rudiš, Zdenka Vydrová<br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
					<div class="gpa__col">
						...
						<h3 class="gpa__projectName">Čestné uznání v kategorii rekonstrukce</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Dvě půdní vestavby, K Vodojemu 3 a 5, Praha 5</span>
							<strong>Autor</strong>: Martin Matiska, Petr Uhlík<br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Rodinný dům v Libni u Prahy</span>
							<strong>Autor</strong>: Petr Hájek, Tomáš Hradečný, Jan Šépka, spolupráce Jan Kolář, Martin Maršík<br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
					<div class="gpa__col">
						...
						<h3 class="gpa__projectName">Čestné uznání v kategorii architektonický design a drobná architektura</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> ZOO Praha - prodejní stánek, řešení prostoru hlavního východu</span>
							<strong>Autor</strong>: Karel Scheib, Tomáš Velinský<br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
				</div>

...
<section class="hero hero--subpage">
	...
	<picture class="hero__image">
		<source srcset="<?php echo $baseurl ?>/assets/images/covers/clenstvi/cover_375.jpg" media="(max-width: 375px)" type="image/jpeg">
		<source srcset="<?php echo $baseurl ?>/assets/images/covers/clenstvi/cover_540.jpg" media="(max-width: 540px)" type="image/jpeg">
        <source srcset="<?php echo $baseurl ?>/assets/images/covers/clenstvi/cover_768.jpg" media="(max-width: 768px)" type="image/jpeg">
		<source srcset="<?php echo $baseurl ?>/assets/images/covers/clenstvi/cover.jpg" media="(max-width: 2560px)" type="image/jpeg">
		<img src="<?php echo $baseurl ?>/assets/images/covers/clenstvi/cover.jpg" alt="">
	</picture>
</section>

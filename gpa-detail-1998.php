...
<head>
	...
	<title>GPA 1998 | Grand Prix Architektů</title>
...
<section class="hero hero--subpage hero--video">
	<div class="hero__wrapper wrapper">
		<img class="hero__logo" src="<?php echo $baseurl ?>/assets/images/competition/logo-1998-tran.png" alt="">
	</div>
			...
			<div class="gpa gpa--projects">
				<div class="gpa__row gpa__row--projects row">
					<div class="gpa__col">
						...
						-->
						<h3 class="gpa__projectName">Národní cena za&nbsp;architekturu 1998</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Dům pečovatelské služby v Českém Krumlově</span>
							<strong>Autor</strong>: Ladislav Lábus, Lenka Dvořáková, Zdeněk Heřman<br>
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<strong>Oceněný</strong>: akad. arch. Jaroslav Kosek<br>
						</span>
					</div>
					<div class="gpa__col">
						<!--
					...
					<div class="gpa__col">
						...
						<h3 class="gpa__projectName">Novostavba</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Divadlo pantomimy Alfred ve dvoře v Praze</span>
							<strong>Autor</strong>: Jindřich Smetana, Tomáš Kulík<br>
							<strong>Cena:</strong> Malá modrá kostka
						</span>
					</div>
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Zdravotní pojišťovna Ministerstva vnitra ČR v Brně</span>
							<strong>Autor</strong>: Libor Veselý, Radek Putna, Tomáš Rusín, Ivan Wahla, Milena Kasalová, Tomáš Beránek<br>
							<strong>Cena:</strong> Malá modrá kostka
						</span>
					</div>
					<div class="gpa__col">
						...
						<h3 class="gpa__projectName">Rekonstrukce</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Rekonstrukce objektu Lázeňského domu služeb v Karlových Varech</span>
							<strong>Autor</strong>: Antonín Polony, Jiří Šejvl<br>
							<strong>Cena:</strong> Malá modrá kostka
						</span>
					</div>
					<div class="gpa__col">
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Lávka pro pěší přes řeku Teplou v Karlových Varech</span>
							<strong>Autor</strong>: Antonín Polony, Jiří Šejvl<br>
							<strong>Cena:</strong> Malá modrá kostka
						</span>
					</div>
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Kancelář pod zahrádkou v Praze</span>
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Obecní úřad a místní knihovna v Šarovech</span>
							<strong>Autor</strong>: Svatopluk Sládeček, Luděk del Maschio, Dušan Mikulášek, Alice Šimečková<br>
					...
					<div class="gpa__col">
						...
						<h3 class="gpa__projectName">Čestné uznání v kategorii novostavba</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Státní okresní archiv ve Strakonicích</span>
							<strong>Autor</strong>: Libor Monhart, Vladimír Krajíc<br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Budova České pojišťovny v Liberci</span>
							<strong>Autor</strong>: Jiří Suchomel, Martin Šaml, Josef Franc, Karel Novotný, Jan Suchánek <br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Interiér rodinného domu v Praze</span>
							<strong>Autor</strong>: Jan Šépka<br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
					<div class="gpa__col">
						...
						<h3 class="gpa__projectName">Čestné uznání v kategorii interiér</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Vstupní a reprezentační prostory právnické kanceláře v Praze</span>
							<strong>Autor</strong>: Ivan Kroupa<br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
					<div class="gpa__col">
						...
						<h3 class="gpa__projectName">Čestné uznání v kategorii interiér</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Architektonická kancelář v Praze</span>
							<strong>Autor</strong>: Ivan Kroupa, spolupráce Tomáš Novotný, Radka Exnerová<br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Detail schodiště / Kukátko, sklad a balírny pro Muzeum chmele v Žatci</span>
							<strong>Autor</strong>: Jiří Müller<br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Obnova parku Potoční v Plzni</span>
							<strong>Autor</strong>: Pavel Šimek, Roman Svojanovský, Jana Kohlová, Hana Skalková, Zdena Rudolfová, Lucie Stehlíková<br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
				</div>

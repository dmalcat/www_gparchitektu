...
<head>
	...
	<title>GPA 1995 | Grand Prix Architektů</title>
...
<section class="hero hero--subpage hero--video">
	<div class="hero__wrapper wrapper">
		<img class="hero__logo" src="<?php echo $baseurl ?>/assets/images/competition/logo-1995-tran.png" alt="">
	</div>
				...
				<div class="gpa__row gpa__row--projects row">
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							...
							<strong>Autor</strong>: Josef Pleskot, Radek Lampa, Jana Vodičková, Vladimír Krajíc<br>
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Megafyt R, II. Etapa, Vrané nad Vltavou</span>
							<strong>Autor</strong>: Josef Pleskot, Radek Lampa, Peter Lacko<br>
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Osvětlovací tělesa, kostel sv. Václava, Stará Boleslav</span>
							<strong>Autor</strong>: Bohumil Fanta, Eva Fantová<br>
							<strong>Cena:</strong> Malá modrá kostka
						</span>
					</div>
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Geodis Brno</span>
					...
					<div class="gpa__col">
						...
						<h3 class="gpa__projectName">Čestné uznání v kategorii novostavba</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Okresní archiv Semily</span>
							<strong>Autor</strong>: Petr Bouřil, Vít Máslo, Lubor Sladký, Ladislav Kuba<br>
							<strong>Cena:</strong> Malá žlutá kostka
						</span>
					</div>
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Restaurace Lví dvůr</span>
							<strong>Autor</strong>: Josef Pleskot, Radek Lampa, Jana Vodičokvá, Peter Lacko<br>
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Vila, Vranné nad Vltavou</span>
							<strong>Autor</strong>: Josef Pleskot, Radek Lampa, Vladimír Krajíc, Jana Vodičková, Marco Svimbersky<br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Půdní vestavba, Praha</span>
							<strong>Autor</strong>: Petr Burian, Petr Malinský, Richard Doležal<br>
							<strong>Atleliér</strong>: DaM
							<strong>Cena:</strong> Diplom
						</span>
					</div>
					<div class="gpa__col">
						...
						<h3 class="gpa__projectName">Čestné uznání v kategorii interiér</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Půdní vestavba</span>
							<strong>Autor</strong>: Rudolf Netík, Michal Froněk, Jan Němeček<br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Rekonstrukce tramvajové tratě, Praha 1</span>
							<strong>Autor</strong>: Ivan Lejčar, Jiří Pejša<br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
				</div>

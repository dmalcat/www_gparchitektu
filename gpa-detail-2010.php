...
<head>
	...
	<title>GPA 2010 | Grand Prix Architektů</title>
...
<section class="hero hero--subpage hero--video">
	<div class="hero__wrapper wrapper">
		<img class="hero__logo" src="<?php echo $baseurl ?>/assets/images/competition/logo-2010-tran.png" alt="">
	</div>
				...
				<div class="gpa__row gpa__row--projects row">
					<div class="gpa__col">
						<div class="gpa__projectImg">
							<img src="<?php echo $baseurl ?>/assets/images/projects/2010/vitez.jpg" alt="">
						</div>
						<h3 class="gpa__projectName">Národní cena za&nbsp;architekturu 2010</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Národní technická knihovna, Praha 6</span>
					...
					<div class="gpa__col">
						<div class="gpa__projectImg">
							<img src="<?php echo $baseurl ?>/assets/images/projects/2010/celozivotni-dilo.jpg" alt="">
						</div>
						<h3 class="gpa__projectName">Cena za&nbsp;Celoživotní dílo</h3>
						<span class="gpa__projectDesc">
							<strong>Oceněný</strong>: prof. Ing. Arch. Věkoslav Pardyl, CSc.<br>
						</span>
					</div>
					<div class="gpa__col">
						<!--
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Central Park Praha, Praha 3</span>
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Přestavba a dostavba továrního areálu AF BKK, Praha 9</span>
							<strong>Autor</strong>: Martina Buřičová, Štěpán Kubíček<br>
							<strong>Ateliér</strong>: caraa.cz<br>
							<strong>Cena:</strong> Malá modrá kostka
						</span>
					</div>
					<div class="gpa__col">
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Vyvýšená cyklistická stezka, Kadaň</span>
							<strong>Autor</strong>: Vít Branda<br> 
							<strong>Ateliér</strong>: a3<br>
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Autobusové nádraží Příbram</span>
							<strong>Autor</strong>: Luis Marques, Robert Hofman, Eva Melicharová<br>
							<strong>Ateliér</strong>: HMArchitekti<br>
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Rodinný dům Kuřim 01, Kuřim</span>
							<strong>Autor</strong>: Jiří Knesl, Jakub Kynčl, Václav Štodl<br>
							<strong>Ateliér</strong>: knesl + kynčl architekti<br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Nová tvář Západočeské galerie v plzni</span>
							<strong>Autor</strong>: Roman Koucký, Šárka Malá<br>
							<strong>Ateliér</strong>: Roman Koucký architektonická kancelář<br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
					<div class="gpa__col">
						...
						<h3 class="gpa__projectName">Čestné uznání v kategorii interiér</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> 66 Gallery, Botas Concept Store, Konviktská ulice, Praha 1 - Staré město</span>
					...
					<div class="gpa__col">
						...
						-->
						<h3 class="gpa__projectName">Čestné uznání v kategorii design, drobná architektura a výtvarné dílo v architektuře</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Akátová věž, kopec Výhon, Židlochovice</span>
							<strong>Autor</strong>: Pavel Jura<br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
				</div>

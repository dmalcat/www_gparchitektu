...
<head>
	...
	<title>GPA 2006 | Grand Prix Architektů</title>
...
<section class="hero hero--subpage hero--video">
	<div class="hero__wrapper wrapper">
		<img class="hero__logo" src="<?php echo $baseurl ?>/assets/images/competition/logo-2006-tran.png" alt="">
	</div>
				...
				<div class="gpa__row gpa__row--projects row">
					<div class="gpa__col">
						<div class="gpa__projectImg">
							<img src="<?php echo $baseurl ?>/assets/images/projects/2006/vitez.jpg" alt="">
						</div>
						<h3 class="gpa__projectName">Národní cena za&nbsp;architekturu 2006</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Bytový dům, Na Okraji, Praha 6</span>
					...
					<div class="gpa__col">
						<div class="gpa__projectImg">
							<img src="<?php echo $baseurl ?>/assets/images/projects/2006/celozivotni-dilo.jpg" alt="">
						</div>
						<h3 class="gpa__projectName">Cena za&nbsp;Celoživotní dílo</h3>
						<span class="gpa__projectDesc">
							<strong>Oceněný</strong>: Ing. arch. Věra Machoninová<br>
						</span>
					</div>
					<div class="gpa__col">
						<!--
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Rekonstrukce divadla Reduta, Brno</span>
							<strong>Autor</strong>: Antonín Novák, Petr Valenta, Radovan Smejkal, Eduard Štěrbák, Miroslav Melena<br>
							<strong>Cena:</strong> Malá modrá kostka
						</span>
					</div>
					<div class="gpa__col">
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Výstava: Karel IV. Císař z Boží milosti. Kultura a umění za vlády posledních Lucemburků 1347 - 1437, Obrazárna Pražského hradu</span>
							<strong>Autor</strong>: Jiří Javůrek, Silvie Bednaříková, Jaroslav Malý<br>
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Besídka, Horní náměstí, Slavonice</span>
							<strong>Autor</strong>: Roman Koucký, Martina Portyková, spolupráce Šárka Malá, Libor Kábrt, Martin Ceplecha<br>
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Rodinný dům Plecháč, Humpolec</span>
							<strong>Autor</strong>: Luděk Rýzner<br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
					<div class="gpa__col">
						...
						<h3 class="gpa__projectName">Čestné uznání v kategorii novostavba</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Rodinný dům Mořina, Mořina</span>

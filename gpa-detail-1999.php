...
<head>
	...
	<title>GPA 1999 | Grand Prix Architektů</title>
...
<section class="hero hero--subpage hero--video">
	<div class="hero__wrapper wrapper">
		<img class="hero__logo" src="<?php echo $baseurl ?>/assets/images/competition/logo-1999-tran.png" alt="">
	</div>
			...
			<div class="gpa gpa--projects">
				<div class="gpa__row gpa__row--projects row">
					<div class="gpa__col">
						...
						-->
						<h3 class="gpa__projectName">Národní cena za&nbsp;architekturu 1999</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Dřevěný domek v Mukařově</span>
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<strong>Oceněný</strong>: Antonín Tenzer<br>
						</span>
					</div>
					<div class="gpa__col">
						<!--
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> IPB pojišťovna v Brně</span>
							<strong>Autor</strong>: Jindřich Škrabal, Ludvík Grym<br>
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Rekonstrukce domu čp. 87 v Náchodě</span>
							<strong>Autor</strong>: Milan Rak, Pavel Rydlo, Libor Rydlo<br>
							<strong>Cena:</strong> Malá modrá kostka
						</span>
					</div>
					<div class="gpa__col">
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> AP Galerie v Holešovicích</span>
							<strong>Autor</strong>: Josef Pleskot<br>
							<strong>Cena:</strong> Malá modrá kostka
						</span>
					</div>
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Dřevěný domek v Mukařově</span>
							<strong>Autor</strong>: Ivan Kroupa, Radka Exnerová<br>
							<strong>Cena:</strong> Malá žlutá kostkaa
						</span>
					</div>
					<div class="gpa__col">
						<!--
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> III. základní škola v Litomyšli</span>
							<strong>Autor</strong>: Aleš Burian, Gustav Křivinka<br>
					...
					<div class="gpa__col">
						...
						<h3 class="gpa__projectName">Čestné uznání v kategorii novostavba</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Dlouhý most v Českých Budějovicích</span>
							<strong>Autor</strong>: Roman Koucký, Tomáš Rotter<br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
					<div class="gpa__col">
						...
						<h3 class="gpa__projectName">Čestné uznání v kategorii novostavba</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Obchodně administrativní centrum Auto Bohemia na Proseku</span>
							<strong>Autor</strong>: Karel Mrázek<br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
					<div class="gpa__col">
						...
						<h3 class="gpa__projectName">Čestné uznání v kategorii novostavba</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Vila Vonoklasy</span>
					...
					<div class="gpa__col">
						...
						<h3 class="gpa__projectName">Čestné uznání v kategorii novostavba</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Spojovací chodba ve Františkových Lázních</span>
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Rekonstrukce velké věže hradu Bezděz</span>
							<strong>Autor</strong>: Václav Girsa, Miroslav Hanzl<br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Red or dead</span>
							<strong>Autor</strong>: Barbora Škorpilová, Jan Nedvěd<br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
					<div class="gpa__col">
						...
						<h3 class="gpa__projectName">Čestné uznání v kategorii interiér</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Knihovna kláštera Dominikánů</span>
					...
					<div class="gpa__col">
						...
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Schody v podkrovním bytě</span>
					...
					<div class="gpa__col">
						...
						<h3 class="gpa__projectName">Čestné uznání v kategorii architektonický design a drobná architektura</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Informační systém pro veletržní palác</span>
							<strong>Autor</strong>: Jakub Cigler, Petr Kolář, Aleš Lapka<br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>
					<div class="gpa__col">
						...
						<h3 class="gpa__projectName">Čestné uznání v kategorii architektonický design a drobná architektura</h3>
						<span class="gpa__projectDesc">
							<span class="gpa__title"><strong>Název projektu:</strong> Anglická ulice ve Františkových Lázních</span>
							<strong>Autor</strong>: Boris Redčenkov, Prokop Tomášek, Jaroslav Wertig <br>
							<strong>Cena:</strong> Diplom
						</span>
					</div>

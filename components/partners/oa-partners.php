<section class="gpTabs">
	<div class="gpTabs__wrapper gpTabs__wrapper--nav wrapper">
		<a class="gpTabs__navItem gpTabs__navItem--active" href="#oa-partners">Partneři Obce architektů</a>
	</div>
	<div class="gpTabs__wrapper gpTabs__wrapper--active wrapper" id="oa-partners">

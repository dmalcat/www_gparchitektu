	...
	<div class="gallery__wrapper wrapper">
		...
		<div class="gallery__row">
			<?php for($counter=1; $counter<7; $counter++) :?>
				<a href="<?php echo $baseurl ?>/assets/images/gallery/2022/tiskova-konference-manes/full/galerie-<?=$counter?>.jpg" class="gallery__item">
					<img class="gallery__item" src="<?php echo $baseurl ?>/assets/images/gallery/2022/tiskova-konference-manes/thumb/galerie-<?=$counter?>.jpg" alt="">
				</a>
			<?php endfor;?>
		</div>

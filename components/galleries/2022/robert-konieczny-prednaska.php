	...
	<div class="gallery__wrapper wrapper">
		...
		<div class="gallery__row">
			<?php for($counter=1; $counter<26; $counter++) :?>
				<a href="../assets/images/gallery/2022/robert-prednaska/full/galerie-<?=$counter?>.jpg" class="gallery__item">
					<img class="gallery__item" src="../assets/images/gallery/2022/robert-prednaska/thumb/galerie-<?=$counter?>.jpg" alt="">
				</a>
			<?php endfor;?>
		</div>

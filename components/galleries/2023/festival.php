...
<section class="gallery gallery--full" id="gallery">
	<div class="gallery__wrapper wrapper">
		...
		<div class="gallery__row">
			<?php for($counter=1; $counter<74; $counter++) :?>
				<a href="<?php echo $baseurl ?>/assets/images/gallery/2023/festival/full/gallery-<?=$counter?>.jpeg" class="gallery__item">
					<img class="gallery__item" src="<?php echo $baseurl ?>/assets/images/gallery/2023/festival/thumb/gallery-<?=$counter?>.jpeg" alt="">
				</a>
			<?php endfor;?>
		</div>
